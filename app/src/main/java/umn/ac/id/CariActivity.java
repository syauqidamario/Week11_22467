        ...
        btnCari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!nim.isEmpty() || !nama.isEmpty() ){
                    String actinWebPage = MainActivity.server+
                            "cari_mahasiswa.php?";
                    Uri builtURI = null;
                    if(!nim.isEmpty() && !nama.isEmpty()){
                        builtURI = Uri.parse(actinWebPage).buildUpon()
                                .appendQueryParameter("nim",nim)
                    ...
                    new AsynCariMahasiswa().execute(builtURI.toString());
                }else{
